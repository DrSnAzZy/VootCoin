...
private slots:
    ...
    void on_BuyVoot_clicked();
    void on_SellVootBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputVoot_textChanged(const QString &arg1);
    ...
    QString BuyVoot(QString OrderType, double Quantity, double Rate);
    QString SellVoot(QString OrderType, double Quantity, double Rate);
